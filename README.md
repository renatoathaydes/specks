...
> Make sure you do not declare a dependency on `ceylon.test` directly in your module to avoid
  version conflicts with Specks because Specks re-exports `ceylon.test`!
